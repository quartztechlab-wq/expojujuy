...
// Bloque "Lo que se viene" y galería fotográfica del Inicio (handoff v9).
import { DESTACADOS } from './inicio.js';
import { GALERIA } from './galeria.js';
// Contenido de la sección Sobre (ver src/data/sobre.js).
import { PERFIL_EXPO, EDICION_ANTERIOR, OBJETIVOS, OBJETIVOS_DESTACADOS, ACTIVIDADES, SECTORES_PARTICIPANTES, VALORES, ORGANIZA, APOYOS, VIDEO_2024 } from './sobre.js';
...
export const DATA = Object.freeze({
  ...
  PERFIL_EXPO, EDICION_ANTERIOR, OBJETIVOS, OBJETIVOS_DESTACADOS, ACTIVIDADES, SECTORES_PARTICIPANTES, VALORES, ORGANIZA, APOYOS, VIDEO_2024,
  DESTACADOS, GALERIA
});
